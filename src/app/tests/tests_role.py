...
class RoleTestCase(BaseAuthTestCase):
    ...
    def test_create_role(self):
        response = self.client.post(self.role_url, headers=self.headers, json=ROLE_DATA)
    ...
    def test_get_all_roles(self):
        ...
        response = self.client.get(self.role_url, headers=self.headers)
    ...
    def test_update_role(self):
        ...
        response = self.client.patch(self.role_url, headers=self.headers, json=data)
        assert response.status_code == HTTPStatus.OK
    ...
    def test_check_roles_api_permission(self):
        ...
        response = self.client.get(self.role_url, headers=headers)
